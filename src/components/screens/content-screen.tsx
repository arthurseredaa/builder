...
export const ContentScreen = ({ question, description, image, cta_text }: ScreenProps) => (
  (
    <Card className="w-full max-w-[100vw] md:max-w-2xl animate-in fade-in zoom-in duration-500">
      ...
      {cta_text && (
        <CardFooter>
          <Button size="lg" className="w-full text-base font-medium active:scale-[0.98] transition-transform">
            {cta_text}
          </Button>
        </CardFooter>
      )}
